...
export default function Mainbox(){
  ...
  return (
    <div className="min-h-screen text-white bg-[rgb(0,31,101)] mt-[-3rem] mb-[3rem]">
           
                  <header>
                  <h2 className={`${heading()} font-bold text-4lg`}>
                  <span className="block text-center">AI Humanizer</span>
                  <span className="block text-center"></span>
                  </h2>
                  
                    <p className="mt-4 text-center text-white-50 text-lg">
                    Refine AI-generated text to ensure natural fluency and adherence to academic writing standards.
                    </p>
                    </header>
                    ...
                    <div className="flex flex-col items-center justify-center w-full max-w-7xl mx-auto mt-16 p-6 rounded-xl mb-10">
                      ...
                      <div className="w-full min-h-[500px] bg-white rounded-l-xl p-8 flex flex-col">
                        <textarea 
                        className="w-full min-h-[200px] max-h-[400px] bg-transparent text-lg resize-none focus:outline-none placeholder:text-black text-black"
