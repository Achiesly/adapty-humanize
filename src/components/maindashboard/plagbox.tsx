...
export default function Plagbox(){
  ...
  return (
            <div className="min-h-screen bg-[rgb(0,31,101)] text-white shadow-2xl animate-gradient-x">
                  <header>
                  <h2 className={`${heading()} font-bold text-4lg`}>
                  <span className="block text-center">Plagiarism Checker</span>
                  <span className="block text-center"></span>
                  </h2>
                  
                    <p className="mt-4 text-center text-white-50 text-lg">
                    Analyze your content for potential plagiarism and receive real-time authenticity insights.
                    </p>
                    </header>

                    

                    <div className="flex flex-col items-center justify-center w-full max-w-7xl mx-auto mt-16 p-6 rounded-xl mb-10">
          ...
          <div id="delete-container" className="flex items-center justify-end gap-2 mt-10" style={{display: "none"}}>
            ...
            <button 
              className="px-10 py-2 bg-blue-600 text-white hover:bg-blue-700 cursor-pointer transision-transform text-sm rounded-md font-semibold"
              onClick={() => {
                const textarea = document.querySelector('textarea');
            ...
            {/* <button className="px-3 py-2 bg-[#2B2B2B] hover:bg-[#333333] rounded-md text-gray-400 text-sm">
              Humanize
            </button> */}
          </div>
        </div>
        ...
        <div className="w-full min-h-[500px] bg-white rounded-r-xl p-8">
          <div className="flex flex-col">
            ...
            <div className="flex gap-2 mt-30 justify-end">
              ...
              >
                <RefreshCw size={16} />
                <span className="invisible group-hover:visible absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded">
                  Retry
                </span>
              </button>
              <button 
                className="p-2 bg-blue-600 text-white hover:bg-blue-700 cursor-pointer transision-transform text-sm rounded-md text-white relative group"
                onClick={() => {
                  const textToHumanize = document.querySelector('textarea');
                  const humanizedTextarea = document.querySelector('textarea[readonly]');
              ...
              >
                <Copy size={16} />
                <span className="copy-button invisible group-hover:visible absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs px-2 py-1 rounded">
                  Copy
                </span>
              </button>
            </div>
