...
import { Shield, Layers, Code } from 'lucide-react';

export default function Part1A() {
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-16 mt-12">
          <h2 className={`text-5xl md:text-5xl font-bold mb-6 text-gray-900 transition-all duration-700 ${
            ...
            <br />
            <span className="mt-2 inline-block">Detection System</span>
          </h2>
          
          <p className={`text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed transition-all duration-700 delay-200 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
            Discover unparalleled accuracy and ease with our tool, 
            <span className="relative inline-block px-1">
              <span className="absolute inset-0 bg-blue-100 rounded-md transform -rotate-1"></span>
              <span className="relative text-blue-800 font-medium">trusted by professionals</span>
            </span> 
            for powerful and reliable plagiarism detection.
          </p>
        </div>

        {/* Feature Cards with Hover Effects */}
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 transition-all duration-1000 delay-300 ${
          ...
          <div className="relative flex flex-col h-full bg-white rounded-lg shadow-xl p-8 transition duration-300 group-hover:translate-y-[-5px]">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-3">Multi-Language Support</h2>
            <p className="text-gray-700 grow font-regular text-9sm">
              Easily verify content in various languages with reliable and accurate
