...
export const tiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      `Access to Ninja Model`,
      `Can be verified with Most Detectors`,
      `Daily Limit (5000 words)`,
  ...
  },
  {
    ...
    description: ``,
    features: [
      `400 words per request`,
      `Access to Ninja model`,
      `Can be verified with All Detectors`,
      `Unlimited Ninja words`,
      `Access to Ghost model`,
      `20,000 Ghost words`,
      `Access to Generator`,
    ],
    featured: false,
      ...
      <div className="w-full flex flex-col items-center">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
            <p className="text-gray-800 dark:text-white mt-15 md:text-4xl lg:text-center max-w-prose font-semibold">
          ...
          {bannerText ? (
            <div className="w-full lg:w-auto flex justify-center my-4">
              <p className="w-full px-4 py-3 text-xs bg-slate-100 text-gray-600 dark:bg-slate-300/30 dark:text-white/80 rounded-xl">
                {bannerText}
              </p>
            </div>
          ) : null}
